        ...
        <div className="lg:flex lg:flex-row w-full">
          <div className="w-full mt-5 flex flex-col lg:flex-col-reverse lg:justify-start lg:items-start">
            <Image
              ...
              className=""
            />{" "}
            <p className="text-8xl mt-3 lg:text-start font-winter">About Us</p>
          </div>
          <div className="lg:flex lg:flex-col lg:justify-center lg:items-center">
            <div className="w-full mt-5 flex flex-col justify-center gap-5">
              ...
              <p className="text-xl font-medium lg:text-2xl">
                ...
                Kompetisi Karya Tulis Ilmiah, Infografis, Try Out, Mobile
                Legends, Business Plan, dan Basket.
              </p>
              <p className="text-xl font-medium lg:text-2xl">
        ...
        <div className="w-full flex flex-row justify-between items-center">
          ...
          <div className="mt-5 flex flex-col justify-center gap-5 w-1/2">
            ...
            <p className="text-xl font-medium lg:text-2xl">
              ...
              Kompetisi ini melibatkan berbagai cabang lomba yang seru dan penuh
              tantangan, seperti Kompetisi Menulis, Olimpiade Cerdas Cermat,
              Poster, Basket, dan Futsal.
            </p>
            <p className="text-xl font-medium lg:text-2xl">
              Tapi itu belum semuanya! Selain ikut berkompetisi, kalian juga
              bisa datang dan menyaksikan keseruan acara AIRCON secara langsung.
              Kalian dapat menyemangati dan mendukung teman-teman atau bahkan
              sekolah kalian yang sedang bertanding di berbagai cabang lomba.
            </p>
            <p className="text-xl font-medium lg:text-2xl">
              Jadi, jangan lewatkan kesempatan emas untuk ikut serta dalam
              AIRCON yang pastinya akan penuh dengan pengalaman seru, tantangan,
              dan kebanggaan. Ayo, persiapkan diri kalian dan tunjukkan
              kemampuan terbaik di AIRCON!
            </p>
          </div>
        </div>
